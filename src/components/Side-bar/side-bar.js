...
const SideBar = obj => {
  console.log(obj, 'laskdjapsjdijm')
  let lang = obj.pathname
    ? obj.pathname.split('/')[1]
      ? obj.pathname.split('/')[1]
      : 'en-US'
    : 'en-US'
  console.log(lang, 'aoqweqwe')
  return (
    <div className="sidebar-wrapper">
      ...
      <ul>
        ...
        <ul className="children ntl_stats">
          <li>
            <a href={`/${lang}/stats/2WzwJAqfKd3QekqmJcKmli/`}>About </a>
          </li>
          <li>
            <a href={`/${lang}/stats/3Yj8RUXHGUebU2k1UfYnqT/`}>
              Employment Trends
            </a>
          </li>
          <li>
            <a href={`/${lang}/stats/ZtDiHSNyWRJYz57YMk7aX/`}>
              Interest Rate Changes
            </a>
          </li>
          <li>
            <a href={`/${lang}/stats/2k7dZil1MPa7B2vbqlNKlH/`}>
              Consumer Confidence
            </a>
          </li>
        </ul>
