...
class MedianPriceTemplate extends React.Component {
  getYear() {
...
MedianPriceTemplate.propTypes = propTypes

export default MedianPriceTemplate

export const pageQuery = graphql`
  query MedianPriceBySlug($id: String!) {
    site {
      siteMetadata {
        languages {
          defaultLangKey
