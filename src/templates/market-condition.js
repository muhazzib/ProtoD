...
class MarketConditionsTemplate extends React.Component {
  getYear() {
...
MarketConditionsTemplate.propTypes = propTypes

export default MarketConditionsTemplate

export const pageQuery = graphql`
  query MarketConditionsQuerySlug($id: String!) {
    site {
      siteMetadata {
        languages {
          defaultLangKey
