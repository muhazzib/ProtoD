...
class SalesCategoryTemplate extends React.Component {
  getYear() {
...
SalesCategoryTemplate.propTypes = propTypes

export default SalesCategoryTemplate

export const pageQuery = graphql`
  query SalesCategoryQuerySlug($id: String!) {
    site {
      siteMetadata {
        languages {
          defaultLangKey
